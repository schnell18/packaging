...
install -d ${RPM_BUILD_ROOT}%{homedir}
install -d ${RPM_BUILD_ROOT}%{homedir}/bin
install -d ${RPM_BUILD_ROOT}%{docsdir}
install -d ${RPM_BUILD_ROOT}%{libdir}
install -d ${RPM_BUILD_ROOT}%{homedir}/webapps
install -d ${RPM_BUILD_ROOT}%{datadir}
install -d ${RPM_BUILD_ROOT}%{datadir}/data
install -d ${RPM_BUILD_ROOT}%{_localstatedir}/log/%{name}
install -d ${RPM_BUILD_ROOT}%{_localstatedir}/run/%{name}
install -d ${RPM_BUILD_ROOT}%{_sysconfdir}/%{_name}
